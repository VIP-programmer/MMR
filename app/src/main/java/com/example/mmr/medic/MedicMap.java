    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.addOnMapClickListener(new MapboxMap.OnMapClickListener() {
            ...
            public boolean onMapClick(@NonNull LatLng point) {
                ...
                coord.put(point.getLatitude(),point.getLongitude());
                return true;
            }
        });
        mapboxMap.addOnMapClickListener(new MapboxMap.OnMapClickListener() {
            ...
            public boolean onMapClick(@NonNull LatLng point) {
                ...
                mapboxMap.getStyle().addSource(new GeoJsonSource(point.toString(),
                ...
                selectLocationButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (hoveringMarker.getVisibility() == View.VISIBLE) {
                            ...
                            intent.putExtra("lng",mapTargetLatLng.getLongitude()+"");
                            intent.putExtra("lat",mapTargetLatLng.getLatitude()+"");
                            setResult(2,intent);
                            finish();
